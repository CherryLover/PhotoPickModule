...
public class PermissionsUtils {
    ...
    public static boolean checkWriteStoragePermission(androidx.fragment.app.Fragment fragment) {
    ...
    public static boolean checkCameraPermission(androidx.fragment.app.Fragment fragment) {
